...
const VERIFIED_ID_ALIASES = {
  ...
  roast_potato: 'roast_potatoes',
  roasted_potato: 'roast_potatoes',
  roasted_potatoes: 'roast_potatoes',
  corn_on_cob: 'sweetcorn',
  corn_cob: 'sweetcorn',
  sweet_corn: 'sweetcorn',
  stilton: 'blue_cheese',
  blue_stilton: 'blue_cheese',
  veg_soup: 'vegetable_soup',
  soft_cheese: 'cream_cheese',
  black_bean: 'black_beans',
  cooked_quinoa: 'quinoa',
  ...
  chivda: 'chevda',
  ganthia: 'sev',
  keema_samosa: 'meat_samosa',
  lamb_samosa: 'meat_samosa',
  aloo_pakora: 'potato_pakora',
  palak_pakora: 'spinach_pakora',
  poori: 'puri',
  gulab_jamen: 'gulab_jamun',
  gulab_jambu: 'gulab_jamun',
  sweet_lassi: 'lassi',
  steak: 'beef_steak',
  gravy: 'gravy',
  carrots: 'carrots',
